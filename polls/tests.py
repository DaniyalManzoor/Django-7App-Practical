...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question(self):
        """
        Question with a pub_date in the future aren't displayee on the index page.
        """
    ...
    def test_two_past_question(self):
        ...
        past_question = create_question(question_text="Past question 2", days-5)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        ...
        """
        future_question = create_question(question_text="Future question.", days5)
